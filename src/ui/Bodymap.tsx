...
const Bodymap = () => {
  ...
  function handleMuscleClick(muscleName: string) {
  ...
  return (
    <div className="flex gap-20 flex-col md:flex-row items-center justify-center mb-10">
      <svg viewBox="0 0 660.46 1206.46" fill="none" className="max-h-[80vh]">
        ...
        <g id="abdominals" className="bodymap">
          <path
        ...
        <g id="obliques" className="bodymap">
          <path
        ...
        <g id="forearms" className="bodymap">
          <path
        ...
        <g id="front-shoulders" className="bodymap">
          <path
      ...
      <svg viewBox="0 0 660.46 1206.46" fill="none" className="max-h-[80vh]">
        ...
        <g id="hamstrings" className="bodymap">
          <path
        ...
        <g id="triceps" className="bodymap">
          <path
        ...
        <g id="lowerback" className="bodymap">
          <path
        ...
        <g id="traps-middle" className="bodymap">
          <path
        ...
        <g id="rear-shoulders" className="bodymap">
          <path
